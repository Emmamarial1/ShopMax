...
class Order(db.Model):
    ...
    # Add these new fields for delivery confirmation
    ...
    delivery_assignments = db.relationship('DeliveryAssignment', backref='order', lazy=True)
    delivery_confirmation = db.relationship('DeliveryConfirmation', backref='order', uselist=False)
